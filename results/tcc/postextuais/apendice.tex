...
No baseline atual, o banco operacional contém 11.904 registros. A deduplicação determinística por DOI/URL retirou 27 registros redundantes; no fluxo PRISMA, 11.877 foram avaliados na triagem, 9.391 foram excluídos e 2.486 avançaram à elegibilidade. Nessa etapa, 2.470 foram excluídos e 16 registros foram retidos operacionalmente: 15 classificados provisoriamente como empíricos, com o 6918 em hold temporal, e o protocolo/proposta contextual 6921. A execução histórica tinha 17 incluídos; uma nova rodada encontrou 23 candidatos e registrou 7 overrides manuais, dos quais 4 ainda aguardam adjudicação de escopo, chegando aos 16 registros atuais. A mudança também envolve nova contagem de ingestão e correção do scoring, e não deve ser tratada como simples troca numérica.
