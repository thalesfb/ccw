...
14 & Risco de viés nos estudos & Apresentar avaliações de risco de viés para cada estudo & Cap. 4, Seção Qualidade Metodológica (reaplicação pendente) \\
\hline
...
18 & Certeza da evidência & Avaliação de certeza/qualidade da evidência & Cap. 4, Seção Qualidade Metodológica (MMAT; reaplicação pendente) \\
\hline
...
No baseline atual, o banco consolidado contém 11.904 registros: 9.413 foram excluídos na triagem, 2.491 avançaram à elegibilidade, 2.475 foram excluídos nessa etapa e 16 estudos foram incluídos. A execução histórica tinha 17 incluídos; uma nova rodada encontrou 23 candidatos e removeu 7 falsos positivos, chegando aos 16 atuais. A mudança também envolve nova contagem de ingestão e correção do scoring, e não deve ser tratada como simples troca numérica.
...
O checklist registra o estado atual do relato. O método para a avaliação de risco de viés foi definido no item 9, e os itens 17, 20 e 21 foram tratados qualitativamente. Entretanto, a avaliação estudo a estudo do conjunto atual ainda não foi reaplicada; por isso, os itens 14 e 18 permanecem pendentes. Os itens 9, 14, 17, 18, 20 e 21, que na fase PTC estavam pendentes, foram tratados na versão TCC da seguinte forma:

\begin{enumerate}
    \item \textbf{Avaliação de qualidade metodológica (itens 9, 14, 18):} Definição do procedimento com o \textbf{Mixed Methods Appraisal Tool (MMAT)} versão 2018 \cite{MMAT2018} para os 16 estudos incluídos; a reaplicação e a tabela final do conjunto atualizado permanecem pendentes.
