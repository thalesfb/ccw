...
No escopo executado, os objetivos definidos na introdução foram atendidos de forma integrada: o \textbf{OE1} pela execução e pelo relato da revisão sistemática; os \textbf{OE2} e \textbf{OE3} pela categorização das técnicas e finalidades pedagógicas dos estudos; o \textbf{OE4} pela apreciação metodológica preliminar por critérios do MMAT; o \textbf{OE5} pelo mapeamento das lacunas técnicas, pedagógicas, metodológicas e éticas; o \textbf{OE6} pelo \textit{pipeline} automatizado e pelos artefatos versionados da revisão; e o \textbf{OE7} pela elaboração da especificação técnica e pedagógica do protótipo.

No escopo executado, o objetivo geral foi alcançado ao combinar o mapeamento sistemático das técnicas computacionais com a derivação de uma especificação de protótipo coerente com as evidências e com os limites identificados.
...
A recorrência de modelos preditivos indicou que tarefas de classificação e estimativa foram frequentes na amostra, mas também revelou uma tendência de reduzir fenômenos educacionais complexos a indicadores de desempenho. A especificação respondeu a esse risco ao separar explicitamente desempenho, proficiência, competência e aprendizagem e ao exigir participação docente na interpretação das saídas.
