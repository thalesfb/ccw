...
A revisão identificou 11.904 registros em quatro fontes científicas. Após a remoção determinística de identidades DOI/URL, a triagem e a avaliação de elegibilidade, 18 registros foram retidos operacionalmente: 17 candidatos empíricos provisórios e 1 protocolo ou proposta contextual. A síntese de evidências considerou apenas os candidatos empíricos e apresentou predominância de aplicações voltadas à predição de desempenho e à estimativa de proficiência, com uso recorrente de modelos supervisionados, especialmente \textbf{\textit{Random Forest}}, SVM, árvores de decisão e redes neurais.
