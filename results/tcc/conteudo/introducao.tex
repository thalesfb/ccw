...
Do ponto de vista acadêmico, a revisão sistemática documentou as estratégias de busca e a seleção dos estudos, e o procedimento de apreciação metodológica foi definido por critérios. O relato foi estruturado com apoio do PRISMA 2020 \cite{PRISMA2020}. A síntese da revisão e a fundamentação pedagógica sustentaram a definição dos requisitos, dos critérios de dados e modelagem, do protocolo de avaliação e da arquitetura de referência apresentados neste trabalho. A apreciação metodológica foi conduzida com o MMAT 2018, mantendo as respostas por critério e explicitando as limitações das fontes disponíveis \cite{MMAT2018}.
...
O escopo executado compreendeu a revisão sistemática da literatura, a definição do procedimento de avaliação metodológica e a elaboração de uma especificação conceitual de protótipo. Essa especificação consolidou princípios pedagógicos, requisitos, critérios para seleção de fontes de dados e modelos, procedimentos de avaliação e uma arquitetura de referência.
