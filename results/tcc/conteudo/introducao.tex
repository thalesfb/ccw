...
Do ponto de vista acadêmico, a revisão sistemática documentou as estratégias de busca e a seleção dos estudos, e o procedimento de apreciação metodológica foi definido por critérios. O relato foi estruturado com apoio do PRISMA 2020 \cite{PRISMA2020}. O PTC foi produzido e avaliado como proposta do TCC; não foi publicado e não constitui uma execução científica anterior da revisão. Assim, os 17 estudos registrados naquela versão são uma referência documental, enquanto o snapshot operacional vigente registra 16 estudos e a reavaliação documental preliminar do MMAT 2018 dos 15 registros empíricos provisórios foi registrada em ledger próprio. O protocolo 6921 é mantido separadamente como registro contextual não aplicável ao MMAT empírico, enquanto a consolidação final permanece pendente \cite{MMAT2018}. A síntese da revisão e a fundamentação pedagógica sustentaram a definição dos requisitos, dos critérios de dados e modelagem, do protocolo de avaliação e da arquitetura de referência apresentados neste trabalho.
...
O escopo executado compreendeu a revisão sistemática da literatura, a definição do procedimento de avaliação metodológica, com registro dos julgamentos históricos disponíveis, e a elaboração de uma especificação conceitual de protótipo. Essa especificação consolidou princípios pedagógicos, requisitos, critérios para seleção de fontes de dados e modelos, procedimentos de avaliação e uma arquitetura de referência.
