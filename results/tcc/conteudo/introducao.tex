...
Do ponto de vista acadêmico, a revisão sistemática documentou as estratégias de busca e a seleção dos estudos, e o procedimento de apreciação metodológica foi definido por critérios. O relato foi estruturado com apoio do PRISMA 2020 \cite{PRISMA2020}; como a nova rodada alterou a composição do conjunto incluído, a reaplicação do MMAT 2018 aos 16 estudos atuais permanece pendente \cite{MMAT2018}. A síntese da revisão e a fundamentação pedagógica sustentaram a definição dos requisitos, dos critérios de dados e modelagem, do protocolo de avaliação e da arquitetura de referência apresentados neste trabalho.
