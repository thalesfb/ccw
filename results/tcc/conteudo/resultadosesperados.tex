...
A Tabela~\ref{tab:mmat-avaliacao} foi gerada automaticamente a partir do arquivo versionado \texttt{research/data/mmat\_assessments.csv}. Dessa forma, os critérios apresentados no TCC, no CSV exportado e no relatório HTML possuem uma fonte única e verificável.
