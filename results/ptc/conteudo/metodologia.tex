...
Nesta etapa foram excluídos \textbf{1.866 registros} (99,1\% dos 1.883 estudos avaliados), refletindo o rigor dos critérios de seleção baseados no \textit{score} de relevância.

\subsection{Inclusão}

Após aplicação do \textit{threshold}, foram incluídos \textbf{17 estudos} para síntese qualitativa, representando uma taxa de inclusão de aproximadamente \textbf{0,18\%} em relação ao total identificado (17/9.431).
