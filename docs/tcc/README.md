...
- [`PRESENTATION_GOVERNANCE.md`](PRESENTATION_GOVERNANCE.md): governança da apresentação Slidev, distinção entre o template fornecido e requisitos do PTC, identidade IFC, QR e critérios de legibilidade.
